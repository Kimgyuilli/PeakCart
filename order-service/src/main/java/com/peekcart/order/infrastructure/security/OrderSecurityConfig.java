...
import com.peekcart.global.security.HeaderTrustSecurityConfigurer;
 ...
 * <p>공통 header-trust 인증 정책은 common-auth {@link HeaderTrustSecurityConfigurer} 로 위임하고,
...
public class OrderSecurityConfig {
    ...
    private final HeaderTrustSecurityConfigurer headerTrustSecurityConfigurer;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        headerTrustSecurityConfigurer.apply(http, ActuatorSecurityConfig.mergedPublicUrls(BUSINESS_PUBLIC_URLS));
        return http.build();
    }
}
